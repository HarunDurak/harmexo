...
| 🔮 **Gizli Kelimeler** | Gizli bonus kelimeler, mor animasyon |
...
| Yıldız | Koşul |
|---|---|
| ⭐⭐⭐ | İpucu yok + tüm Gizli kelimeler bulundu |
| ⭐⭐ | İpucu yok |
| ⭐ | İpucu kullanıldı |
...
- Bonus Gizli kelimeler +5 ◆ ekstra ödül verir

### 🔮 Gizli (Bonus) Kelimeler
